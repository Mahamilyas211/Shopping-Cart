            ...
            <div class="row">
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column">
                        <div class="sec-title">
                            <span class="title">About GostO</span>
                            <h2>We are Creative Tech Enthusiast working since 2024</h2>
                        </div>
                        <div class="text">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam exercitationem reiciendis quaerat corrupti nam itaque, minus cum, ullam eligendi beatae, officia facilis repudiandae ipsa molestias ut illo suscipit pariatur hic.
                            creating useful plugins that you need.
                        </div>
                        <div class="text">
                            We are here to serve you next level tutorial that currently in trend to match you with your expertise. GostO is a learning website. where you can find many good quality content related to web development and tutorials about plugins. here we are using html, html5, css, css3, jquery & javascript along with inspirational UI design layout by professionals by using Photoshop and adobe illustrator.
                        </div>
                        <div class="btn-box">
                            <Link to='/contact'>
                    ...
                    <div class="inner-column wow fadeInLeft">
                        ...
                        <figure class="image-1">
                            <a href="#" class="lightbox-image" data-fancybox="images">
                                <img title="GostO.com" src="ecommerce.png.png" alt="" />
                            </a>
                        </figure>
                    </div>
                </div>
